...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // block
      char dummy2[sizeof (BlockStmtAST*)];
      ...
      // binding
      char dummy10[sizeof (VarBindingAST*)];
      ...
      // stmts
      char dummy14[sizeof (std::vector<RootAST*>)];

      // vardefs
      char dummy15[sizeof (std::vector<VarBindingAST*>)];
    ...
    TOK_IDENTIFIER = 290,          // "id"
    TOK_NUMBER = 291,              // "number"
    TOK_LOWER_THAN_ELSE = 292      // LOWER_THAN_ELSE
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_IDENTIFIER = 35,                       // "id"
        S_NUMBER = 36,                           // "number"
        S_LOWER_THAN_ELSE = 37,                  // LOWER_THAN_ELSE
        ...
        S_ifstmt = 51,                           // ifstmt
        S_forstmt = 52,                          // forstmt
        S_block = 53,                            // block
        S_vardefs = 54,                          // vardefs
        S_binding = 55,                          // binding
        S_exp = 56,                              // exp
        S_initexp = 57,                          // initexp
        S_expif = 58,                            // expif
        S_relexp = 59,                           // relexp
        S_condexp = 60,                          // condexp
        S_idexp = 61,                            // idexp
        S_optexp = 62,                           // optexp
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_block: // block
        value.move< BlockStmtAST* > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, BlockStmtAST*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const BlockStmtAST*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_block: // block
        value.template destroy< BlockStmtAST* > ();
        break;
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_block: // block
        value.copy< BlockStmtAST* > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_block: // block
        value.move< BlockStmtAST* > (YY_MOVE (s.value));
        break;
